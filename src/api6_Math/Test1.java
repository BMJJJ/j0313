...
public class Test1 {
	public static void main(String[] args) {
		...
		//반올림 :  Math.round() - 무조건 정수형반올림(소수첫째자리에서 반올림후 정수로 표시)음수일떄 부호때고 생각하기(올리루 -붙이기)
		...
		//소수 첫째자리에서의 반올림
		//1234.567 + 0.5 = (int)1235.067 =1235
		//소수 둘째자리 : 1234.567 + 0.05 = (int)1234.617 * 10  =(int)12346.17 = 12346 / 10 = 1234.6
		System.out.println(Math.round(d1*10) / 10.0);
		//소수 셋째자리 : 1234.567 + 0.005 = (int)1234.572 * 100  =(int)123457.2 = 123457 / 100 = 1234.57
		...
		//소수부 무조건 올림 : Math.ceil() 반올림이 조건 안맞아도(1234여도) 무조건 올림
		...
		//System.out.println("7.count() : " + Math.count(10,20,30)); (x) // 자바에서 개수를 구할떄는 length() 또는 size() 이용);
