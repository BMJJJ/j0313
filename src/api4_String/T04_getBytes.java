...
public class T04_getBytes {
	public static void main(String[] args) {
		// 아스키코드 : 영문1글자가 1Byte, 한글 : 2Byte
		//EUC-KR : 영문1글자가 1Byte, 한글 : 2Byte
		// 유니코드 : UTF-8 영문1글자가 1Byte, 한글 : 3Byte
		String str1 = "안녕하세요!";
		String str2 = "Hello!";
		...
		byte[] b1 = str1.getBytes();//getBytes문자열을 배열로 받아서 교환
		...
		try {
			...
			System.out.println("b3 : " + b3.toString());//오버라이드 하지않아 주소가 나온다.toString()은 생략가능
			...
			System.out.println("b2의 길이 : " + b2.length);	
			System.out.println("b2 : " + b2.toString());//오버라이드 하지않아 주소가 나온다.toString()은 생략가능
