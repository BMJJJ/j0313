...
/*
  ...
  StingBuffer객체 : mutable객체로서 크기를 변경할수 있다. 동기화를 제공, 멀티스레드를 제공 및 사용하기적절하다. 가변길이문자열에 적당하다.
  StingBuilder객체 : mutable객체로서 크기를 변경할수 있다. 동기화여부가 불분명
  성능 : StingBuilder > StringBuffer >> String
 */
