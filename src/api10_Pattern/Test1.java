...
public class Test1 {
	public static void main(String[] args) {
		...
		System.out.println();
		//프로그램에서의 적용예...
		if(Pattern.matches(regEx, str1)) System.out.println("str1숫자가 맞습니다.");
		else System.out.println("str1숫자가 아님 값(문자?)을 포함하고 있습니다.");
		
		if(Pattern.matches(regEx, str2)) System.out.println("str2숫자가 맞습니다.");
		else System.out.println("str2숫자가 아님 값(문자?)을 포함하고 있습니다.");
	}
}
